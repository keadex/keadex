...
const resizeBox = (parent: C4BaseElastiContainerComponent) => {
  ...
  if (
    ...
    // Only if the auto layout is not enabled I recalculate the size and position
    // of the elastic box basing on the inner elements
    // If the auto layout is enabled, size and position have been already set.
