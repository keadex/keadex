...
import { renderElements } from '../rendering-system/diagram-renderer'
...
export const C4BaseElasticContainer = (
  ...
  // ----- Box
  const box = createBox(elementSpec, options, parent)
  ...
  if (data.sub_elements) {
    innerObjects = renderElements(undefined, data.sub_elements, diagramSpec, {
...
const createBox = (
  ...
  const box = new fabric.Rect({
    ...
    left: boxSpecs?.position?.left ?? ELEMENT.SIZES.DEFAULT_LEFT,
    top: boxSpecs?.position?.top ?? ELEMENT.SIZES.DEFAULT_TOP,
