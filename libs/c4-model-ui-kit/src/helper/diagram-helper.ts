...
import { capitalCase, constantCase, noCase, paramCase } from 'change-case'
...
export const diagramDirName = (diagramHumanName: string): string => {
  return paramCase(noCase(diagramHumanName))
}
...
export const c4ElementTypePathName = (c4ElementType: C4ElementType): string => {
  return pluralize(paramCase(noCase(c4ElementType)))
}
