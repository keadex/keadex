...
import { AddElementTagType } from '../models/autogenerated/AddElementTagType'
...
export const ADD_ELEMENT_TAG_TYPES: AddElementTagType[] = ['AddElementTag']

export const AUTO_LAYOUT_ORIENTATIONS: DiagramOrientation[] = [
  'TopToBottom',
  'LeftToRight',
]
