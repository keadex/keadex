...
1. Open Keadex Mina
2. Click on *"Create a new project"* in the welcome page
...
Check out the *"Features"* section of this documentation for details on the available Mina features. 
...
Check out the *"Plugins and Components"* section of this documentation for more details.