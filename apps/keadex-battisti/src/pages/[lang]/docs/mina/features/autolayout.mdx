...
For this reason, Mina provides **three options** for rendering diagrams:
  ...
  3. **Hybrid Auto Layout**: Enable auto layout to generate initial positions, then disable it to customize them. This is a compromise in terms of speed and final rendering.
