...
<Tabs items={['Windows', 'macOS', 'Linux']} defaultIndex="0">
  <Tabs.Tab>
    ```bat
    : Download Mina CLI v2.9.0 or your required version
    curl -L -O https://github.com/keadex/keadex/releases/download/mina-cli%402.9.0/mina-cli-Windows-msvc-x86_64.zip
  ...
  <Tabs.Tab>
    ```bat
    : Download Mina CLI v2.9.0 or your required version
    curl -L -O https://github.com/keadex/keadex/releases/download/mina-cli%402.9.0/mina-cli-macOS-arm64.tar.gz
  ...
  <Tabs.Tab>
    ```bat
    : Download Mina CLI v2.9.0 or your required version
    curl -L -O https://github.com/keadex/keadex/releases/download/mina-cli%402.9.0/mina-cli-Linux-gnu-x86_64.tar.gz
