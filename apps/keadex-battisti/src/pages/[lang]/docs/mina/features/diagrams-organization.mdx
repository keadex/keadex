...
<p align="center" className="my-7">
  <Image src={organizeScreenshot} alt="Keadex Mina screenshot of the diagrams organization view" width={600} className="border-solid border-dark-primary border" />
</p>
...
However, in large companies with many architectures to describe, managing numerous diagrams can become challenging. To facilitate this task, Mina provides the following features:
  ...
  - **[Diagram Links](/en/docs/mina/features/diagrams-links)**: By linking your diagrams, you enable navigation between them and improve the user experience.
