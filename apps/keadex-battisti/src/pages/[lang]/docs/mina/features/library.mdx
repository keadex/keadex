...
<iframe
  src="https://www.youtube.com/embed/pfYGNEbJ9Kg"
...
1. Click on the *library* icon (<FontAwesomeIcon icon={faBook} className="inline w-4 mx-2" />) in the sidebar
...
3. You have two options:
    1. Right mouse click -> *"Import from the library"* 
...
3. You have two options:
    ...
    2. Click on the icon **...** and then *open*
...
3. Click on the icon **...** and then *delete*