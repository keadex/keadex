...
import minaScreenshot from '../../../../../public/img/mina/mina-plantuml.jpg'
...
<p align="center" className="mt-10 pb-7">
  <Image src={minaScreenshot} alt="Keadex Mina screenshot of the editor" width={600} className="border-solid border-dark-primary border" />
</p>

Keadex Mina is an open source desktop application available for Linux, MacOS and Windows.
