...
ROUTES[PROJECTS] = { path: PROJECTS }

ROUTES[PROJECT_KEADEX_MINA] = { path: PROJECT_KEADEX_MINA }
...
ROUTES[PROJECT_KEADEX_BATTISTI] = { path: PROJECT_KEADEX_BATTISTI }
ROUTES[PROJECT_KEADEX_DOCS] = { path: PROJECT_KEADEX_DOCS }
ROUTES[PROJECT_C4MODEL_UI_KIT] = { path: PROJECT_C4MODEL_UI_KIT }
ROUTES[PROJECT_KEADEX_UI_KIT] = { path: PROJECT_KEADEX_UI_KIT }
...
ROUTES[DOCS] = { path: DOCS }
ROUTES[DOCS_OVERVIEW] = { path: DOCS_OVERVIEW }
ROUTES[MINA_DOCS] = { path: MINA_DOCS }
ROUTES[MINA_INTRODUCTION] = { path: MINA_INTRODUCTION }
ROUTES[MINA_ARCHITECTURE] = { path: MINA_ARCHITECTURE }
ROUTES[MINA_ARCH_OVERVIEW] = { path: MINA_ARCH_OVERVIEW }
ROUTES[MINA_ARCH_MODULES] = { path: MINA_ARCH_MODULES }
ROUTES[MINA_RENDERING_SYSTEM] = { path: MINA_RENDERING_SYSTEM }
ROUTES[MINA_GETTING_STARTED] = { path: MINA_GETTING_STARTED }
ROUTES[MINA_GS_QUICK_START] = { path: MINA_GS_QUICK_START }
ROUTES[MINA_GS_PROJECT_STRUCTURE] = { path: MINA_GS_PROJECT_STRUCTURE }
ROUTES[MINA_FEATURES] = { path: MINA_FEATURES }
ROUTES[MINA_AUTOLAYOUT] = { path: MINA_AUTOLAYOUT }
ROUTES[MINA_CLI_OVERVIEW] = { path: MINA_CLI_OVERVIEW }
ROUTES[MINA_CLI_COMMANDS] = { path: MINA_CLI_COMMANDS }
ROUTES[MINA_CONTINUOUS_INTEGRATION] = { path: MINA_CONTINUOUS_INTEGRATION }
ROUTES[MINA_DEEP_LINKS] = { path: MINA_DEEP_LINKS }
ROUTES[MINA_DEPENDENCY_TABLE] = { path: MINA_DEPENDENCY_TABLE }
ROUTES[MINA_DIAGRAMS_ORG] = { path: MINA_DIAGRAMS_ORG }
ROUTES[MINA_EXPORT] = { path: MINA_EXPORT }
ROUTES[MINA_HOOKS] = { path: MINA_HOOKS }
ROUTES[MINA_INTELLISENSE] = { path: MINA_INTELLISENSE }
ROUTES[MINA_LIBRARY] = { path: MINA_LIBRARY }
ROUTES[MINA_LINKS] = { path: MINA_LINKS }
ROUTES[MINA_LOW_CODING] = { path: MINA_LOW_CODING }
ROUTES[MINA_PLANTUML] = { path: MINA_PLANTUML }
ROUTES[MINA_SEARCH] = { path: MINA_SEARCH }
ROUTES[MINA_SSR] = { path: MINA_SSR }
ROUTES[MINA_SHARE_DIAGRAMS] = { path: MINA_SHARE_DIAGRAMS }
ROUTES[MINA_TAGS] = { path: MINA_TAGS }
ROUTES[MINA_THEMES] = { path: MINA_THEMES }
ROUTES[MINA_VERSIONING] = { path: MINA_VERSIONING }
ROUTES[MINA_PLUGINS] = { path: MINA_PLUGINS }
ROUTES[MINA_PLUGINS_OVERVIEW] = { path: MINA_PLUGINS_OVERVIEW }
ROUTES[MINA_CONFLUENCE_PLUGIN] = { path: MINA_CONFLUENCE_PLUGIN }
ROUTES[C4_MODEL_UI_KIT_DOCS] = { path: C4_MODEL_UI_KIT_DOCS }
ROUTES[C4_MODEL_UI_KIT_ARCH] = { path: C4_MODEL_UI_KIT_ARCH }
ROUTES[C4_MODEL_UI_KIT_API] = { path: C4_MODEL_UI_KIT_API }
...
ROUTES[COOKIE_DECLARATION] = { path: COOKIE_DECLARATION }
ROUTES[PRIVACY_POLICY] = { path: PRIVACY_POLICY }
ROUTES[TERMS_AND_CONDITIONS] = { path: TERMS_AND_CONDITIONS }
