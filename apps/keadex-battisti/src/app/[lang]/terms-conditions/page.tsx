    ...
    <div className="page font-light flex flex-col pb-10">
      ...
      <ul className="list-disc">
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Keadex.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Keadex, accessible from{' '}
            <a
              href="https://www.keadex.io"
      ...
      <ul className="list-disc">
        <li>
          ...
          <a
            href="https://github.com/keadex"
            rel="external nofollow noreferrer"
            target="_blank"
          >
            https://github.com/keadex
          </a>
        </li>
      </ul>
    </div>
