...
const PrivacyPolicy: NextPage<PageProps> = async () => {
  return (
    <div className="page font-light flex flex-col pb-10">
      ...
      <p>
        At Keadex, accessible from keadex.io, one of our main priorities is the
        privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by Keadex and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Keadex. This policy is not applicable to any
      ...
      <p>
        Keadex follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, Keadex uses &apos;cookies&apos;. These cookies
      ...
      <p>
        ...
        advertising partners of Keadex.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Keadex, which are sent directly
      ...
      <p>
        Note that Keadex has no access to or control over these cookies that are
      ...
      <p>
        Keadex&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Keadex does not knowingly collect any Personal Identifiable Information
