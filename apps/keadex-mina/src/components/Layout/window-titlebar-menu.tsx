...
> = (
  ...
  const openProject = (path: string) => {
    // The "open project" button is not available in the web version of the window titlebar,
    // so it's ok to always not pass the dir handle
  ...
  const handleCheckForUpdates = () => {
    checkForUpdates(data.showModal, t, true)
  }

  const handleDownloadMinaCLI = () => {
    open('https://keadex.dev/en/projects/keadex-mina')
  }
  ...
  menuItemsProps.push({
    ...
    subMenuItems: [
      ...
      {
        isHeaderMenuItem: false,
        id: 'wbar_help_download_mina_cli',
        label: t('common.action.download_mina_cli').toString(),
        onClick: handleDownloadMinaCLI,
      },
      ...(ENV_SETTINGS.WEB_MODE
        ? [
            {
              isHeaderMenuItem: false,
              id: 'wbar_help_download_desktop_app',
              label: t('common.action.download_desktop_app').toString(),
