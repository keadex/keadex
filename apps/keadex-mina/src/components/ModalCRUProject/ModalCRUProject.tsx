    ...
    return (
      <div>
        ...
        <div className="modal__body">
          <div className="text-brand1 my-2 text-xl">{t('common.project')}</div>
          <div className="h-[1px] w-full bg-brand1"></div>
          {props.mode === 'create' && (
            <IconButton
              icon={faFolder}
          ...
          />
          <div className="text-brand1 mb-2 mt-10 text-xl">
            {t('common.editor')}
          </div>
          <div className="h-[1px] w-full bg-brand1"></div>
          ...
          {AI_ENABLED && (
            <>
              <div className="text-brand1 mb-2 mt-10 text-xl">
                {t('project_settings.ai_integration')}
              </div>
              <div className="h-[1px] w-full bg-brand1"></div>
              <Input
                type="text"
                label={t('project_settings.ai_api_key')}
              ...
              <Input
                type="text"
                label={t('project_settings.ai_api_base_url')}
              ...
              <Input
                type="text"
                label={t('project_settings.ai_model')}
