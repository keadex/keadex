...
import { deleteDiagram, executeHook } from '../../core/tauri-rust-bridge'
...
function menu(
  ...
  function handleEditOrDuplicateDiagram(type: 'edit' | 'duplicate') {
    showModal({
      id: `${type}DiargamModal`,
      title: `${t(`common.${type}`)} ${t('common.diagram').toLowerCase()}`,
      body: (
        <ModalCRUDiagram
    ...
    menuItemsProps: [
      {
        ...
        subMenuItems: [
          ...
          },
          {
            ...
            onClick: () => handleEditOrDuplicateDiagram('edit'),
          },

          {
            ...
            onClick: () => handleEditOrDuplicateDiagram('duplicate'),
          },
          {
            isHeaderMenuItem: false,
            id: `${id}_delete`,
