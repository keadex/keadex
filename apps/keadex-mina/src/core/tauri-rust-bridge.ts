...
import { UserSettings } from '../models/autogenerated/UserSettings'
...
export async function executeHook(payload: HookPayload): Promise<boolean> {
  return invoke(EXECUTE_HOOK_CMD, { payload })
}

/*########################*/
/* APP SETTINGS COMMANDS  */
/*########################*/
export const GET_USER_SETTINGS_CMD = 'get_user_settings'
export const SAVE_USER_SETTINGS_CMD = 'save_user_settings'

export async function getUserSettings(): Promise<UserSettings> {
  return invoke(GET_USER_SETTINGS_CMD)
}
export async function saveUserSettings(
  userSettings: UserSettings,
): Promise<UserSettings> {
  return invoke(SAVE_USER_SETTINGS_CMD, { userSettings })
}
