...
export const EXTERNAL_DIAGRAMS_PROJECT_ROOT_URL_PARAM = ':projectRootUrl?'
export const EXTERNAL_DIAGRAMS_DIAGRAM_URL_PARAM = ':diagramUrl?'
export const EXTERNAL_DIAGRAMS_GH_TOKEN_PARAM = ':ghToken?'
export const EXTERNAL_DIAGRAMS_BASE_URL = `/external-diagrams`
export const EXTERNAL_DIAGRAMS = `${EXTERNAL_DIAGRAMS_BASE_URL}/${EXTERNAL_DIAGRAMS_PROJECT_ROOT_URL_PARAM}/${EXTERNAL_DIAGRAMS_DIAGRAM_URL_PARAM}/${EXTERNAL_DIAGRAMS_GH_TOKEN_PARAM}`
