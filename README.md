...
| :white_check_mark: | [libs/mina-mcp-server](https://github.com/keadex/keadex/tree/main/libs/mina-mcp-server)               | Library that provides the MCP Server to connect AI applications to Keadex Mina projects.   | ![GitHub package.json version (subfolder of monorepo)](https://img.shields.io/github/package-json/v/keadex/keadex?filename=libs%2Fmina-mcp-server%2Fpackage.json)                                                       | Typescript, Rust, Wasm | MCP Rust SDK        |
